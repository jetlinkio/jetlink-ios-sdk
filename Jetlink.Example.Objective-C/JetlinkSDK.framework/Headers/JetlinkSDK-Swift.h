...
//! Project version number for JetlinkSDK.
FOUNDATION_EXPORT double JetlinkSDKVersionNumber;

//! Project version string for JetlinkSDK.
FOUNDATION_EXPORT const unsigned char JetlinkSDKVersionString[];
